...
\begin{wrapfigure}{l}{0.38\textwidth}
	\vspace{-30pt}
	\begin{center}
		\includegraphics[width=0.25\textwidth]{figures/stack_frame_v3.pdf}
	\end{center}
	\vspace{-20pt}
...
%save Figure \ref{fig:original_function_operation_process} explains the execution process when a function is called, and Figure \ref{fig:original_function_operation_stack} shows the associated stack changes after each operation is performed. 
Each rectangle represents two bytes in the stack. 
%save The numbers below each stack denote the operation(s) that changed the stack. 
...
\begin{figure}
	\centering
	\includegraphics[width=1.0\textwidth]{figures/original_function_operations_stack_v3}
	\vspace{-15pt}
