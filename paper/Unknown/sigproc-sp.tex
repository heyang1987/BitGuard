...
\title{A Software Approach for Protecting Embedded Systems Memory from Single Event Upsets}
...
%
% 1st. author
 \alignauthor Jiannan Zhai, Yangyang He, Yuheng Du, Jason O. Hallstrom\\
    \affaddr{School of Computing, Clemson University, Clemson SC, 29634-0974  USA}\\
    %\affaddr{}
    \affaddr{ \{jzhai, yyhe, yuhengd, jasonoh\}@clemson.edu}\\
}
...
\keywords{Embedded systems, single event upset, memory protection} % NOT required for Proceedings
