...
%%Finally, improving the system level robustness so that the base operating system corrects these errors independently as in trip-*-+le modular redundancy.
\vspace{-15pt}
...
% 3 citations needed: Hamming Codes, TMR, RAID
