...
.global	intervalCounter
	.section	.bss.intervalCounter,"aw",@nobits
	.type	intervalCounter, @object
	.size	intervalCounter, 4
intervalCounter:
	.skip 4,0
.global	num
...
/* Stack Frame Size Saving Segment End */
	...
	sts (size)+1,r25
	sts size,r24
	lds r24,intervalCounter
	lds r25,(intervalCounter)+1
	lds r26,(intervalCounter)+2
	lds r27,(intervalCounter)+3
	adiw r24,1
	adc r26,__zero_reg__
	adc r27,__zero_reg__
	sts intervalCounter,r24
	sts (intervalCounter)+1,r25
	sts (intervalCounter)+2,r26
	sts (intervalCounter)+3,r27
	lds r24,intervalCounter
	lds r25,(intervalCounter)+1
	lds r26,(intervalCounter)+2
	lds r27,(intervalCounter)+3
...
/* #NOAPP */
	...
	eor r24,r25
	st X,r24
	sts intervalCounter,__zero_reg__
	sts (intervalCounter)+1,__zero_reg__
	sts (intervalCounter)+2,__zero_reg__
	sts (intervalCounter)+3,__zero_reg__
.L4:
...
/* function __vector_18 size 173 (126) */
	.size	__vector_18, .-__vector_18
	.section	.rodata.C.9.1640,"a",@progbits
	.type	C.9.1640, @object
	.size	C.9.1640, 7
C.9.1640:
	.byte	0
	.byte	-62
...
/* prologue end (size=10) */
	...
	std Y+38,r25
	std Y+37,r24
	ldi r30,lo8(C.9.1640)
	ldi r31,hi8(C.9.1640)
	std Y+40,r31
	std Y+39,r30
	ldi r31,lo8(7)
	std Y+41,r31
...
.L11:
	...
	std Y+7,r26
	std Y+8,r27
	ldi r18,lo8(0x451c4000)
	ldi r19,hi8(0x451c4000)
	ldi r20,hlo8(0x451c4000)
	ldi r21,hhi8(0x451c4000)
	ldd r22,Y+5
	ldd r23,Y+6
	ldd r24,Y+7
	ldd r25,Y+8
...
/* #NOAPP */
	...
	std Y+1,r24
	rjmp .L8
/* epilogue: frame size=46 */
/* epilogue: noreturn */
/* epilogue end (size=0) */
/* function main size 289 (279) */
	.size	main, .-main
	.comm size,2,1
	.comm addr,2,1
	.comm p,2,1
/* File "sendNum.c": code  462 = 0x01ce ( 405), prologues  34, epilogues  23 */
